...
setwd( "C:\\Users\\hmreu\\Documents\\Especialización en Ciencias de Datos\\Mineria de Datos\\" )  #establezco la carpeta donde voy a trabajar
#cargo el dataset
...
setwd("C:\\Users\\hmreu\\Documents\\Especialización en Ciencias de Datos\\Mineria de Datos\\")   #Establezco el Working Directory DEL EXPERIMENTO
