...
modelo  <- rpart("clase_ternaria ~ .",  #quiero predecir clase_ternaria a partir de el resto de las variables
                 data = dtrain,
                 xval=0,
                 cp=  -0.790604781099229,   #esto significa no limitar la complejidad de los splits
                 minsplit=  1993,     #minima cantidad de registros para que se haga el split
                 minbucket=  993,     #tamaño minimo de una hoja
...
fwrite( entrega, 
        file= "./labo/exp/KA2001/K101_rpart_con_hiperparametros_optimos.csv", 
        sep= "," )