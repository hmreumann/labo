...
setwd("C:\\Users\\hmreu\\Documents\\Especializaci�n en Ciencias de Datos\\Mineria de Datos\\")   #Establezco el Working Directory
...
param  <- list( "num.trees"=       2339,  #cantidad de arboles
                "mtry"=             9,  #cantidad de variables que evalua para hacer un split  sqrt(ncol(dtrain))
                "min.node.size"=  520,  #tamaño minimo de las hojas
                "max.depth"=        24   # 0 significa profundidad infinita
              )

set.seed(102199) #Establezco la semilla aleatoria
...
archivo_salida  <- "./labo/exp/KA2411/KA_411_008.csv"
