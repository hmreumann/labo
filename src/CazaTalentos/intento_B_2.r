...
Estrategia_B  <- function()
{
  ...
  planilla_cazatalentos[ ids_juegan1,  tiros1 := 25 ]  #registro en la planilla que tiran 70 tiros
  resultado1  <- gimnasio_tirar( ids_juegan1, 25)
  ...
  cuartil  <- planilla_cazatalentos[ ids_juegan1, quantile(aciertos1)[2] ]
  ids_juegan2  <- planilla_cazatalentos[ ids_juegan1 ][ aciertos1 >= cuartil, id ]

  planilla_cazatalentos[ ids_juegan2,  tiros2 := 25 ]  #registro en la planilla que tiran 70 tiros
  resultado2  <- gimnasio_tirar( ids_juegan2, 25)
  ...
  #A la mitad mejor la hago tirar 70 tiros cada uno
  #La mediana siempre parte a un conjunto en dos partes de igual cantidad
  cuartil  <- planilla_cazatalentos[ ids_juegan2, quantile(aciertos2)[2] ]
  ids_juegan3  <- planilla_cazatalentos[ ids_juegan2 ][ aciertos2 >= cuartil, id ]

  planilla_cazatalentos[ ids_juegan3,  tiros3 := 25 ]  #registro en la planilla que tiran 70 tiros
  resultado3  <- gimnasio_tirar( ids_juegan3, 25)
  ...
  #A la mitad mejor la hago tirar 70 tiros cada uno
  #La mediana siempre parte a un conjunto en dos partes de igual cantidad
  cuartil  <- planilla_cazatalentos[ ids_juegan3, quantile(aciertos3)[2] ]
  ids_juegan4  <- planilla_cazatalentos[ ids_juegan3 ][ aciertos3 >= cuartil, id ]

  planilla_cazatalentos[ ids_juegan4,  tiros4 := 25 ]  #registro en la planilla que tiran 70 tiros
  resultado4  <- gimnasio_tirar( ids_juegan4, 25)
  ...
  #A la mitad mejor la hago tirar 70 tiros cada uno
  #La mediana siempre parte a un conjunto en dos partes de igual cantidad
  cuartil  <- planilla_cazatalentos[ ids_juegan4, quantile(aciertos4)[2] ]
  ids_juegan5  <- planilla_cazatalentos[ ids_juegan4 ][ aciertos4 >= cuartil, id ]

  planilla_cazatalentos[ ids_juegan5,  tiros5 := 25 ]  #registro en la planilla que tiran 70 tiros
  resultado5  <- gimnasio_tirar( ids_juegan5, 25)
  ...
  #La mediana siempre parte a un conjunto en dos partes de igual cantidad
  cuartil  <- planilla_cazatalentos[ ids_juegan5, quantile(aciertos5)[2] ]
  ids_juegan6  <- planilla_cazatalentos[ ids_juegan5 ][ aciertos5 >= cuartil, id ]
