...
dataset  <- fread("./datasets/paquete_premium_202011_ext.csv", stringsAsFactors= TRUE)
...
modelo  <- lgb.train( data= dtrain,
                      param= list( objective=        "binary",
                                   max_bin=              31,
                                   learning_rate=         0.0100387870491052,
                                   num_iterations=      904,
                                   num_leaves=          716,
                                   min_data_in_leaf=   3015,
                                   feature_fraction=      0.363848726573724,
...
setwd( "C:\\Users\\hmreu\\Documents\\Especialización en Ciencias de Datos\\Mineria de Datos\\labo\\exp\\KA5520\\" )

archivo_salida  <- "KA_552_003_FE_BO.csv"
