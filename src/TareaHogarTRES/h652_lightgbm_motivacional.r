...
#gcloud compute instances create th3-lightgbm-motivacional --custom-extensions --custom-vm-type=n1 --custom-cpu=8 --custom-memory=64 --provisioning-model=SPOT --instance-termination-action=DELETE --image=image-dm --image-project=data-mining-2022-351123 --boot-disk-type=pd-standard --boot-disk-size=256GB --scopes=cloud-platform --metadata=shutdown-script=suicidio.sh --tags http-server
